...
<html>
    ...
    <body> 
        ...
        <div class="text-center">
            ...
            <p id="subtitulo">Cadastro Morador</p>
            <br>
        </div>
        ...
        <input type="hidden" name="idloc" id="idloc" value="<?php echo $row[0]; ?>">
            ...
            <div class="row">
                ...
                <div class="row">
               <div class="col-md-6 mb-3">
                <label for="pet"><strong> Possui PET?</strong></label>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <label for="cozinhar"><strong> Saber Cozinhar?</strong></label>
                    <select id="cozinhar" class="form-control" name="cozinhar" required>
                      <option selected disabled value="">Selecione</option>
                      <option value=0>Não</option>
                      <option value=1>Sim</option>
            ...
            <div class="row" id="pp">
                ...
                <select id="moto"  class="form-control" name="moto" required>
                  <option selected disabled value="">Selecione</option>
                  <option value=0>Não</option>
                  <option value=1>Sim</option>
            ...
            <div class="col-md-4 mb-3">
                ...
                <select id="carro"   class="form-control" name="carro" required>
                  <option selected disabled value="">Selecione</option>
                  <option value=0>Não</option>
                  <option value=1>Sim</option>
                </select>
            ...
            <fieldset class="grupo" id="botao">
                <div class="campo">
                <div>
                    <button class="botao" type="submit" onclick="return valida()">Atualizar</button>  
                </div>
